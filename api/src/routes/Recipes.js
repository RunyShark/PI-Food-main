...
router.get("/", async (req, res, next) => {
  ...
  try {
    if (name) {
      apiExter = (
        await axios.get(
          `https://api.spoonacular.com/recipes/complexSearch?apiKey=acb1d2bf922b44ca8c07a8c9b8d4c432&number=100&addRecipeInformation=true`
        )
      ).data.results
...
router.get("/:id", async (req, res, next) => {
  try {
    ...
    if (id.includes("-")) {
      ...
      esta = (
        await axios.get(
          `https://api.spoonacular.com/recipes/${id}/information?apiKey=acb1d2bf922b44ca8c07a8c9b8d4c432`
        )
      ).data;
