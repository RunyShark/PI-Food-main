...
router.get("/", async (req, res, next) => {
  ...
  try {
    if (name) {
      apiExter = (
        await axios.get(
          `https://api.spoonacular.com/recipes/complexSearch?apiKey=3c881b47378f4381b4d274f26ef37bdc&number=100&addRecipeInformation=true`
        )
      ).data.results
...
router.get("/:id", async (req, res, next) => {
  try {
    ...
    if (id.includes("-")) {
      ...
      esta = (
        await axios.get(
          `https://api.spoonacular.com/recipes/${id}/information?apiKey=3c881b47378f4381b4d274f26ef37bdc`
        )
      ).data;
